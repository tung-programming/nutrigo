...
export default function ScanLoading({ open, message = "Analyzing image...", submessage = "AI is processing your image", onCancel }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md rounded-2xl bg-gradient-to-br from-slate-900/90 to-slate-800/90 border border-emerald-500/20 shadow-2xl p-8 flex flex-col items-center text-center">
