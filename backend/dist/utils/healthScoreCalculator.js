...
exports.adjustScoreByConfidence = adjustScoreByConfidence;
// ============================================
...
function applyBonus(s, amount) {
    return clampScore(s + amount);
}
function applyPenalty(s, amount) {
    return clampScore(s - amount);
}
// ============================================
// BEVERAGE SCORING
// ============================================
function calculateBeverageScore(d) {
    let s = 100;
...
// SNACK SCORING
// ============================================
function calculateSnackScore(d) {
    let s = 100;
...
// DAIRY SCORING
// ============================================
function calculateDairyScore(d) {
    let s = 100;
    // Sugar (per 100g)
    if (d.sugar > 20)
        s -= 30;
...
// ============================================
function calculatePackagedFoodScore(d) {
    let s = 100;
    if (d.calories > 400)
        s -= 25;
...
// ============================================
function calculateCerealScore(d) {
    let s = 100;
    // Sugar
    if (d.sugar > 15)
        s -= 40;
...
// FROZEN FOOD SCORING
// ============================================
function calculateFrozenFoodScore(d) {
    let s = 100;
    if (d.sodium > 1000)
        s -= 35;
...
// CONDIMENT SCORING
// ============================================
function calculateCondimentScore(d) {
    let s = 100;
    if (d.sodium > 1000)
        s -= 35;
...
// DESSERT SCORING
// ============================================
function calculateDessertScore(d) {
    let s = 70;
    if (d.sugar > 30)
        s -= 30;
    else if (d.sugar > 20)
...
// ============================================
function calculateGeneralScore(d) {
    let s = 100;
    if (d.calories > 300)
        s -= 15;
    if (d.sugar > 15)
...
// ============================================
function adjustScoreByConfidence(score, confidence) {
    if (!confidence)
        return score;
